...
/**
 * Mobicents Sip Serlvets's {@link SipStandardContext} backed by a ShrinkWrap
 * {@link Archive}; capable of being deployed into 
 * the Mobicents Sip Servlets on Tomcat Embedded container
 * 
 * @author Jean Deruelle
 * @version $Revision: $
 */
public class ShrinkWrapSipStandardContext extends SipStandardContext implements Assignable
{
   ...
   /**
    * Temporary directory into which we'll extract the {@link ConvergedSipWebArchive}s
    */
   ...
   /**
    * Creates a new {@link ShrinkWrapSipStandardContext} using the
    * specified underlying archive
    * 
    * @throws IllegalArgumentException If the archive is not specified
    */
   public ShrinkWrapSipStandardContext(final Archive<?> archive) throws IllegalArgumentException
   {
      // Invoke super
      super();
